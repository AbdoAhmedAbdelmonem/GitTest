...
export default function LuraChatbot() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content: "مرحباً! أنا Explo 🤖، المساعد الذكي لموقع Chameleon FCDS. يمكنك تصفح الأسئلة الشائعة من القائمة الجانبية من الايقونة اعلي اليمين . كيف يمكنني مساعدتك اليوم؟",
      isBot: true,
      timestamp: new Date(),
    },
  ])
